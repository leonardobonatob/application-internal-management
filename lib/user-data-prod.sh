...
cd config/ 
echo "export const API_BASE_URL = 'http://52.3.112.175:8888/api/';
export const BASE_URL = 'http://52.3.112.175:8888/';
export const DOWNLOAD_BASE_URL = 'http://52.3.112.175:download/';
